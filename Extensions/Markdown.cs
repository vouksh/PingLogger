...
{
    /// <summary>
    /// Credit to theunrepentantgeek
    /// https://github.com/theunrepentantgeek/Markdown.XAML
    /// Also https://stackoverflow.com/a/29198173/1659361 to get the BitmapImage from embedded resource. 
    /// </summary>
    public class Markdown : DependencyObject
    {
        ...
        private Inline ImageInlineEvaluator(Match match)
        {
            ...
            try
            {
				...
				{
                    imgSource = GetSourceForOnRender(url);
				}
            }
            catch (Exception)
            {
